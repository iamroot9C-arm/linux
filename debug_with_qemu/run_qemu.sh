qemu-system-arm -M vexpress-a9 -m 1024M -snapshot -s -S -smp 4 -kernel ../arch/arm/boot/zImage -initrd busybox-1.20.2/rootfs.img -serial stdio -append "root=/dev/ram rdinit=/sbin/init console=ttyAMA0 debug"
